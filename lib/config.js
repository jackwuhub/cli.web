                            ...
                            choices:[
                                {
                                    ...
                                    value: 'https://gitee.com/wuguangshuai/template.admin.vue3.tdsign.git'
                                },
                                {
                                    title:'elementUI',
                            ...
                            choices:[
                                {
                                    ...
                                    description: '腾讯团队最新出品UI库',
                                    value: 'https://gitee.com/wuguangshuai/template.h5.vue3.tdsign.git'
                                },
                                {
                                    title:'vantUI',
                    ...
                    choices:[
                        {
                            ...
                            description: '腾讯团队最新出品UI库',
                            value: 'https://gitee.com/wuguangshuai/template.wechat.tdsign.git'
                        },
                        {
                            title:'VantUI',
                            description: '有赞老牌UI库',
